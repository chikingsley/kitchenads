...
import { Button } from "/workspaces/kitchenads/components/ui/button"
import { Input } from "/workspaces/kitchenads/components/ui/input"
import { Textarea } from "/workspaces/kitchenads/components/ui/textarea"
import { Select } from "/workspaces/kitchenads/components/ui/select"
import { Card, CardContent, CardFooter, CardHeader, CardTitle } from "/workspaces/kitchenads/components/ui/card"
import { Bitcoin, BarChart, MessageCircle, CreditCard, Mail, Send } from "lucide-react"

export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen bg-[#0a403b]">
